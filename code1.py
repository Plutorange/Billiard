...
class Main_Menu(object):
    def setupUi(self, main_menu):
        main_menu.setObjectName("Game_Menu")
        ...
        self.ball_image = QLabel(main_menu)
        ...
        self.btn_play = QtWidgets.QPushButton(main_menu)
        ...
        self.btn_stats = QtWidgets.QPushButton(main_menu)
        ...
        self.btn_unlogin = QtWidgets.QPushButton(main_menu)
        ...
        self.btn_exit = QtWidgets.QPushButton(main_menu)
    ...
    def retranslateUi(self, main_menu):
        ...
        self.btn_play.setText(_translate("main_menu", "Играть"))
        self.btn_stats.setText(_translate("main_menu", "Статистика"))
        self.btn_unlogin.setText(_translate("main_menu", "Выйти из аккаунтов"))
        self.btn_exit.setText(_translate("main_menu", "Закрыть"))
...
class Login(QtWidgets.QWidget, Main_Menu):
    ...
    def __init__(self):
        ...
        self.btn_stats.clicked.connect(self.btn_newuser_handler)
        self.btn_play.clicked.connect(self.btn_ok_handler)
