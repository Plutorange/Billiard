...
class Main_Menu(object):
    ...
    def retranslateUi(self, main_menu):
        ...
        main_menu.setWindowTitle(_translate("main_menu", "Billiard2D"))
        self.l_title.setText(_translate("main_menu", "Billiard2D"))
        self.btn_ok.setText(_translate("main_menu", "OK"))
        self.btn_newuser.setText(_translate("main_menu", "Registration"))
        self.txt_username.setPlaceholderText(_translate("main_menu", "Enter PlayerName1"))
        self.txt_password.setPlaceholderText(_translate("main_menu", "Enter Password"))
...
class Ui_NewUser(object):
    ...
    def retranslateUi(self, NewUser):
        _translate = QtCore.QCoreApplication.translate
        NewUser.setWindowTitle(_translate("NewPlayer", "NewPlayer"))
        self.l_newuser.setText(_translate("NewPlayer", "Billiard2D"))
        self.txt_firstname.setPlaceholderText(_translate("NewPlayer", "Enter your FirstName"))
        self.txt_lastname.setPlaceholderText(_translate("NewPlayer", "Enter your LastName"))
        self.txt_username.setPlaceholderText(_translate("NewPlayer", "Enter PlayerName"))
        self.lineEdit.setPlaceholderText(_translate("NewPlayer", "Enter Password"))
        self.btn_ok.setText(_translate("NewPlayer", "OK"))
        self.Back.setText(_translate("NewPlayer", "Back"))
